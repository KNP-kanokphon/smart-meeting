    ...
    Modal.confirm({
      ...
      onOk: async () => {
        const data: any = {
          ...
          bridday: e.dob !== undefined ? e.dob : null,
          age: e.age !== undefined ? e.age : null,
          ...
          passport: e.passport !== undefined ? e.passport : null,
          certificate: e.certificate !== undefined ? e.certificate : null,
          workpermit: e.workpermit !== undefined ? e.workpermit : null,
          work: e.work !== undefined ? e.work : null,
          job_position: e.job_position !== undefined ? e.job_position : null,
          salary: e.salary !== undefined ? e.salary : null,
          work_station: e.work_station !== undefined ? e.work_station : null,
          work_number: e.work_number !== undefined ? e.work_number : null,
          work_villageno:
            e.work_villageno !== undefined ? e.work_villageno : null,
          work_alley: e.work_alley !== undefined ? e.work_alley : null,
          work_road: e.work_road !== undefined ? e.work_road : null,
          work_sub_district:
            e.work_sub_district !== undefined ? e.work_sub_district : null,
          work_district: e.work_district !== undefined ? e.work_district : null,
          work_province: e.work_province !== undefined ? e.work_province : null,
          work_postal_code:
            e.work_postal_code !== undefined ? e.work_postal_code : null,
          phone_office: e.phone_office !== undefined ? e.phone_office : null,
          all_assets: e.all_assets !== undefined ? e.all_assets : null,
          previous_job: e.previous_job !== undefined ? e.previous_job : null,
          criminalcase: e.criminalcase !== undefined ? e.criminalcase : null,
          position_guild:
            e.position_guild !== undefined ? e.position_guild : [],
          guild: e.guild !== undefined ? e.guild : null,
          others: e.others !== undefined ? e.others : null,
        };
